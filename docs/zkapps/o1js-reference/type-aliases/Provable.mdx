...
Defined in: [lib/provable/types/provable-intf.ts:27](https://github.com/o1-labs/o1js/blob/46b9772d07785397c4bd76a102bc9f6730d321bb/src/lib/provable/types/provable-intf.ts#L27)
...
This function is the reverse operation of calling [toFields](Provable.mdx#tofields) and toAuxilary methods on an element of type `T`.
