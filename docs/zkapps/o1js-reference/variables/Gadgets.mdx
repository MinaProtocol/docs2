...
Defined in: [lib/provable/gadgets/gadgets.ts:36](https://github.com/o1-labs/o1js/blob/46b9772d07785397c4bd76a102bc9f6730d321bb/src/lib/provable/gadgets/gadgets.ts#L36)
...
Defined in: [lib/provable/gadgets/blake2b.ts:77](https://github.com/o1-labs/o1js/blob/46b9772d07785397c4bd76a102bc9f6730d321bb/src/lib/provable/gadgets/blake2b.ts#L77)
...
Prove that each of the given [Field3](Gadgets.mdx#field3) elements is "almost" reduced modulo f,
i.e., satisfies the assumptions required by [Gadgets.ForeignField.mul](Gadgets.mdx#mul) and other gadgets:
...
Note: This is much more efficient than using [Gadgets.ForeignField.add](Gadgets.mdx#add) and [Gadgets.ForeignField.sub](Gadgets.mdx#sub) separately to
compute the multiplication inputs and outputs, and then using [Gadgets.ForeignField.mul](Gadgets.mdx#mul) to constrain the result.

The sums passed into this method are "lazy sums" created with [Gadgets.ForeignField.Sum](Gadgets.mdx#sum-2).
You can also pass in plain [Field3](Gadgets.mdx#field3) elements.

**Assumptions**: The assumptions on the _summands_ are analogous to the assumptions described in [Gadgets.ForeignField.mul](Gadgets.mdx#mul):
...
See [Gadgets.ForeignField.mul](Gadgets.mdx#mul) for assumptions on inputs and usage examples.
...
Different than [Gadgets.ForeignField.mul](Gadgets.mdx#mul), this fails on unreduced input `x`, because it checks that `x === (x/y)*y` and the right side will be reduced.
...
All of the above assumptions are checked by [Gadgets.ForeignField.assertAlmostReduced](Gadgets.mdx#assertalmostreduced).
...
Lazy sum of [Field3](Gadgets.mdx#field3) elements, which can be used as input to [Gadgets.ForeignField.assertMul](Gadgets.mdx#assertmul).
...
Defined in: [lib/provable/gadgets/sha256.ts:103](https://github.com/o1-labs/o1js/blob/46b9772d07785397c4bd76a102bc9f6730d321bb/src/lib/provable/gadgets/sha256.ts#L103)
