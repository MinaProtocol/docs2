...
- A user interface (UI) for users to interact with the zkApp
  <figure>
    <img
      src="/img/3_zkApps_Structure.jpg"
      width="100%"
      alt="Diagram showing two parts of a zkApp"
    />
  </figure>
...
<figure>
  <img
    src="/img/4_zkApps_Prover_Function.jpg"
    width="90%"
    alt="Diagram showing private and public inputs to prover function to create zero knowledge proof"
  />
</figure>
...
<figure>
  <img
    src="/img/5_zkApps_Verifier_Function.jpg"
    width="90%"
    alt="Diagram showing verifier function validation"
  />
</figure>
...
<figure>
  <img
    src="/img/6_zkApps_DeploySmartContract.jpg"
    width="75%"
    alt="Diagram showing deployment of a Mina zkApp smart contract"
  />
</figure>
...
<img
  src="/img/7_zkApps_DeploySmartContract.jpg"
  width="95%"
  alt="Diagram of a zkApp that includes JavaScript and the UI"
/>
...
Each zkApp account provides 32 fields of 32 bytes each of arbitrary storage. You may store anything here as long as it fits in the size provided.
