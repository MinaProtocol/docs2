...
1. You install the stop-slot release ([4.0.0](https://github.com/MinaProtocol/mina/releases/tag/4.0.0)) during the Pre-Upgrade phase.
...
- Install the stop-slot release ([4.0.0](https://github.com/MinaProtocol/mina/releases/tag/4.0.0)) **before** the _stop-transaction-slot_
