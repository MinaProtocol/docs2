...
If you have `mina-generate-keypair` installed, you will need to first `sudo apt remove mina-generate-keypair` before installing the stop-slot release package.
