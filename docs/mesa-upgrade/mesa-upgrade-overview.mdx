...
description: Overview of the Mesa upgrade for the Mina network, including MIP-7 (expanded on-chain state), MIP-8 (actions and events), and MIP-9 (account update limits).
keywords:
  - Mesa upgrade
  - MIP-7
  - MIP-8
